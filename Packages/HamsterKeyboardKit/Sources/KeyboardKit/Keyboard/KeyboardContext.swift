...
public class KeyboardContext: ObservableObject {
  ...
  @Published
  public var onehandMode: Bool = false
  
  @Published
  var onehandOnLeft: Bool = false
...
public extension KeyboardContext {
  ...
  var enableOnehandMode: Bool {
    hamsterConfiguration?.keyboard?.enableOnehandMode ?? false
  }
  
  var isOnehandModeOnLeft: Bool {
    hamsterConfiguration?.keyboard?.isOnehandModeOnLeft ?? true
  }
